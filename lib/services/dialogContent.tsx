...
export const dialogContentOnLogoClick = {
  ...
  content: (
    <Box sx={{ padding: 2 }}>
      ...
      <Typography variant="body1" sx={{ marginBottom: 2 }}>
        For the proof of concept (POC), the app currently supports age verification. Additionally, other verification
        options, such as address and membership, are also possible using the same technology.
      </Typography>
      <Typography variant="body1" sx={{ marginBottom: 2 }}>
...
export const dialogContentRegistrationPage = {
  ...
  content: (
    <Box sx={{ padding: 2 }}>
      <Typography variant="body1">
        To initiate your journey with nZKid, kindly fill out the registration form, create a unique passkey, and complete the
        registration process. Ensure the accuracy of the information provided, as it will undergo verification through a
        trusted domain.
      </Typography>
    </Box>
  ),
    ...
    <>
      <Box sx={{ padding: 2 }}>
        ...
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
          ...
          Profile verifiaction is done using authoritative domain for this POC demo we are using simulated domain.
        </Typography>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
          <VerifiedIcon color="success" />
          Your information has been authenticated and verified by the authoritative domain. Clicking on the icon allows you
          to access the verification details.
        </Typography>
        <Typography variant="body1">You can also delete your profile information by clicking the delete button.</Typography>
      </Box>
    </>
  ),
};
  ...
  content: (
    <>
      <Box sx={{ padding: 2 }}>
        ...
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
          The application allows you to generate various types of nZKP certificates. Currently, age verification is
          supported. Moreover, other verification options, such as address and membership, are also feasible using the same
          technology.
        </Typography>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
          Once generated, sharing your certificate is effortless. Copy the link, send it as a message, or email it to those
          who need to verify your information.
        </Typography>
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
  ...
  content: (
    <>
      <Box sx={{ padding: 2 }}>
        ...
        <Typography variant="body1">We are here to assist you and address any inquiries you may have.</Typography>
      </Box>
    </>
  ),
};
