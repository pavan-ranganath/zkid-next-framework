        ...
        <Box sx={styles.cardContainer}>
            <Card sx={{ ...styles.card }}>
                <CardContent sx={styles.centeredContent}>
                    <Typography variant="h5" sx={{ textTransform: 'capitalize' }}>nZKid Digital Identity</Typography>
                    ...
                    <Grid container spacing={2} style={styles.spacingBetween}>
                        ...
                        <Grid item xs={8} sx={{ ...styles.centeredContent, alignItems: 'start' }}>
                            ...
                            <Typography variant="body1">{userInfo.userInfo?.dob.value ? moment(epochToDate(userInfo.userInfo?.dob.value)).format('DD, MMM, YYYY') : ''}</Typography>
...
export default ZKidDigitalCardDisplay;
