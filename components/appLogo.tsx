...
const AppLogoSVG = ({ theme }: { theme: string }) => {
  ...
  return (
    <svg viewBox="0 0 76.65306 25.262392" version="1.1" id="svg445" xmlns="http://www.w3.org/2000/svg">
      <defs id="defs442" />
      <g id="layer1" transform="translate(-39.416085,-135.86881)">
        <g id="g505" fill={fillColor}>
          <g transform="matrix(0.31555111,0,0,0.31555111,36.27004,132.72245)" id="g6" fill={fillColor}>
