                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ paddingTop: 20 }}>
                            ...
                            <TextField
                                ...
                                helperText={errors.claimDate?.message ? errors.claimDate?.message : "Please provide the date you wish to compare and verify the age for."}
                                fullWidth
                                sx={{ mb: 2 }}
                            />
                            <TextField
                            ...
                            <DialogContentText sx={{ marginBottom: 2 }}>
                                Claim Statement: {`On ${watch("claimDate") || "____-__-__"}, the age is equal to or below ${watch("claimAge") || "___"}`}
                            </DialogContentText>
...
export default AgeverificationProverInputModal;
