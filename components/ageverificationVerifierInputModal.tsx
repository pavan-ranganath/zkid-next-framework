...
const AgeverificationVerifierInputModal: React.FC<AgeverificationVerifierInputModalProps> = ({ open, onClose, data }) => {
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ paddingTop: 20 }}>
                            ...
                            <TextField
                                ...
                                helperText={errors.date?.message ? errors.date?.message : "Please provide the date you wish to compare and verify the age for."}
                                fullWidth
                                sx={{ mb: 2 }}
                            />
                            <TextField
...
export default AgeverificationVerifierInputModal;
