...
function DigitalSignatureTag({
  certificate,
  ageVerificationXMLCertificate,
}: {
  certificate: pki.Certificate;
  ageVerificationXMLCertificate: AgeVerificatingCertificate;
}) {
  ...
  return (
    <div style={{ border: "1px solid", padding: "10px", borderRadius: "5px" }}>
      ...
      <Typography variant="body1">
        {" "}
        Date: {moment(epochToDate(ageVerificationXMLCertificate.Certificate.issueDate)).format("DD, MMM, YYYY")}
      </Typography>
      {/* more info button */}
      <Button variant="text" fullWidth size="small" onClick={handleOpen}>
        More info
      </Button>
      <Dialog open={open} onClose={handleClose} aria-labelledby="certificate-dialog">
        ...
        <DialogContent>
          ...
          <Box mt={2}>
            ...
            <Typography variant="body2">{signingCert["ds:X509IssuerName"]}</Typography>
            <Typography variant="body1">
